...
MainState.prototype = {
    ...
    create: function () {
        ...
        this.dealerPosRate = [{x: 0.632, y: 0.312}, {x: 0.796, y: 0.349}, {x: 0.841, y: 0.434}, {
            x: 0.694,
            y: 0.570
        }, {x: 0.44, y: 0.574}, {x: 0.306, y: 0.570}, {x: 0.154, y: 0.434}, {x: 0.204, y: 0.349}, {x: 0.368, y: 0.312}];
        ...
        this.userPosRate = [{x: 0.692, y: 0.152}, {x: 0.856, y: 0.187}, {x: 0.914, y: 0.54}, {
            x: 0.754,
            y: 0.734
        }, {x: 0.5, y: 0.734}, {x: 0.246, y: 0.734}, {x: 0.086, y: 0.54}, {x: 0.144, y: 0.187}, {x: 0.308, y: 0.152}];
        this.userSizeRate = {width: 0.096, height: 0.262};
        var userCoinRate = [{x: 0.656, y: 0.292}, {x: 0.82, y: 0.329}, {x: 0.831, y: 0.484}, {
            x: 0.673,
            y: 0.613
        }, {x: 0.464, y: 0.557}, {x: 0.305, y: 0.613}, {x: 0.139, y: 0.484}, {x: 0.108, y: 0.329}, {x: 0.27, y: 0.292}];
        ...
        var userTextRate = [{x: 0.69, y: 0.292}, {x: 0.856, y: 0.329}, {x: 0.768, y: 0.484}, {
            x: 0.61,
            y: 0.613
        }, {x: 0.5, y: 0.557}, {x: 0.339, y: 0.613}, {x: 0.173, y: 0.484}, {x: 0.142, y: 0.329}, {x: 0.306, y: 0.292}];
        ...
        this.cardPosRate = [{x: 0.344, y: 0.456}, {x: 0.422, y: 0.456}, {x: 0.5, y: 0.456}, {
            x: 0.578,
            y: 0.456
        }, {x: 0.656, y: 0.456}];
        ...
        var preflopBKRate = [{x: 0.722, y: 0.203}, {x: 0.889, y: 0.241}, {x: 0.945, y: 0.594}, {
            x: 0.787,
            y: 0.788
        }, {x: 0.167, y: 0.788}, {x: 0.011, y: 0.594}, {x: 0.071, y: 0.241}, {x: 0.236, y: 0.203}];
        ...
        style = {
            ...
            fill: "#FFFFFF",
            wordWrap: false,
            wordWrapWidth: this.button1.width,
            align: "center"
        };
        ...
        style = {
            ...
            fill: "#FFFFFF",
            wordWrap: false,
            wordWrapWidth: this.button2.width,
            align: "center"
        };
        ...
        style = {
            ...
            fill: "#FFFFFF",
            wordWrap: false,
            wordWrapWidth: this.button3.width,
            align: "center"
        };
        ...
        style = {
            ...
            fill: "#FFFFFF",
            wordWrap: false,
            wordWrapWidth: 0.6 * this.waitbutton1.width,
            align: "left"
        };
        ...
        style = {
            ...
            fill: "#FFFFFF",
            wordWrap: false,
            wordWrapWidth: 0.6 * this.waitbutton2.width,
            align: "left"
        };
        ...
        style = {
            ...
            fill: "#FFFFFF",
            wordWrap: false,
            wordWrapWidth: 0.6 * this.waitbutton3.width,
            align: "left"
        };
        ...
        style = {
            ...
            fill: "#FFFFFF",
            wordWrap: true,
            wordWrapWidth: this.chipPoolBK.width,
            align: "center"
        };
    ...
    handleButton: function (data) {
        ...
        if (this.dealer == null) {
            ...
            if (user) {
                ...
                this.tween.to({
                        x: this.dealerPosRate[seatIndex].x * this.imageBK.width + this.xOffset,
    ...
    */
    ...
    _userPositionBySeatNum: function (seatNum) {
        ...
        return {
            x: this.userPosRate[userindex].x * this.imageBK.width + this.xOffset,
            y: this.userPosRate[userindex].y * this.imageBK.height + this.yOffset
        }
    },

    _sendCardAnimation: function () {
        var sendPoint = {
            x: this.chipPoolBK.x + this.chipPoolBK.width * 0.14,
            y: this.chipPoolBK.y + this.chipPoolBK.height * 0.5
        }
        var userList = []
        for (var i = 0; i < this.userList.length; i++) {
